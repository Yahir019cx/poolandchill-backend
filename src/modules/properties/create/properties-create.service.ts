  ...
  private async executeSaveLocation(propertyId: string, dto: CreatePropertyDto): Promise<void> {
    ...
    const result = await this.databaseService.executeStoredProcedure(
      ...
      [
        ...
        { name: 'Street', type: sql.NVarChar(200), value: loc.street?.trim() || null },
        { name: 'ExteriorNumber', type: sql.NVarChar(20), value: loc.exteriorNumber?.trim() || null },
        { name: 'InteriorNumber', type: sql.NVarChar(20), value: loc.interiorNumber?.trim() || null },
        { name: 'Neighborhood', type: sql.NVarChar(100), value: loc.neighborhood?.trim() || null },
        { name: 'ZipCode', type: sql.VarChar(10), value: loc.zipCode?.trim() || null },
